...
.catch(error => console.error('Error:', error));`,
  ...
  return (
    <div className="bg-gray-50 px-32">
      ...
      <section id="api-information" className="px-6 py-6">
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">API Information</h2>
        <p className="text-lg text-gray-700">
          Welcome to the [API Name] documentation. Our API allows you to
          integrate powerful features into your applications, providing access
          to [describe the purpose of the API and its core features]. Whether
          you're building a mobile app, a website, or any platform that requires
          seamless integration, our API is built to be fast, secure, and
          reliable.
        </p>
      </section>

      <section id="supported-api-types" className="px-6 py-6">
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">Supported API Types</h2>
        <p className="text-lg text-gray-700 mb-4">
          The [API Name] supports the following HTTP methods for making
          requests:
        </p>
        <ul className="list-disc pl-8 space-y-2 text-gray-700">
          <li><strong>GET</strong>: Used to retrieve data from the server. Example: <code>GET /users</code></li>
          <li><strong>POST</strong>: Used to send data to the server. Example: <code>POST /users</code></li>
          <li><strong>PUT</strong>: Used to update existing resources. Example: <code>PUT /users/id</code></li>
          <li><strong>DELETE</strong>: Used to delete a resource. Example: <code>DELETE /users/id</code></li>
        </ul>
      </section>

      <section id="accepted-platforms" className="px-6 py-6">
  <h2 className="text-2xl font-bold text-indigo-600 mb-4">Accepted Platforms</h2>
  <p className="text-lg text-gray-700 mb-4">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
    <div className="flex flex-col items-center justify-center space-y-2 text-gray-700">
      <Image
        src="/apple.png" // Replace with actual iOS logo image
        alt="iOS"
        width={40}
        height={40}
      />
    ...
    <div className="flex flex-col items-center justify-center space-y-2 text-gray-700">
      <Image
        src="/android.png" // Replace with actual Android logo image
        alt="Android"
        width={40}
        height={40}
      />
    ...
    <div className="flex flex-col items-center justify-center space-y-2 text-gray-700">
      <Image
        src="/chrome.png" // Replace with actual Chrome logo image
        alt="Chrome"
        width={40}
        height={40}
      />
    ...
    <div className="flex flex-col items-center justify-center space-y-2 text-gray-700">
      <Image
        src="/firefox.png" // Replace with actual Firefox logo image
        alt="Firefox"
        width={40}
        height={40}
      />
    ...
    <div className="flex flex-col items-center justify-center space-y-2 text-gray-700">
      <Image
        src="/safari.png" // Replace with actual Safari logo image
        alt="Safari"
        width={40}
        height={40}
      />
    ...
    <div className="flex flex-col items-center justify-center space-y-2 text-gray-700">
      <Image
        src="/microsoft.png" // Replace with actual Edge logo image
        alt="Edge"
        width={40}
        height={40}
      />
      ...
      <section id="expected-body" className="px-6 py-6">
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">Expected Body Content</h2>
        <p className="text-lg text-gray-700 mb-4">
          When making API requests, especially for <code>POST</code> and{" "}
          <code>PUT</code> methods, make sure to send the correct body content.
        </p>
        <h3 className="text-xl font-semibold text-indigo-600 mb-2">Example JSON Payload</h3>
  ...
  "password": "securePassword123"
      ...
      <section id="authentication" className="px-6 py-6">
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">Authentication</h2>
        <p className="text-lg text-gray-700 mb-4">
          Our API uses <strong>API Key</strong> authentication. Each registered
          user will be given a unique API key to include in their request
          headers.
        </p>
      </section>
      ...
      {showJson && (
        <div className="mt-6 bg-gray-800 p-6 rounded-lg">
          <pre className="text-white">{JSON.stringify(dummyData, null, 2)}</pre>
        </div>
      )}

      <section className="px-6 py-12">
        <h2 className="text-2xl font-bold text-indigo-600 mb-4">Your API Access Key</h2>
