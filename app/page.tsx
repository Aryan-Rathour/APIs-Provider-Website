        ...
        <section className="flex flex-wrap gap-4 md:gap-12 lg:gap-12 mb-16 justify-center">
          <Card className="w-96 bg-gray-50 border border-gray-200 shadow-md rounded-xl p-6 custom-hover-border">
            <CardHeader className="text-gray-900 font-semibold">
              <CardTitle className="text-complementary">Popular APIs</CardTitle>
            ...
            <CardContent className="text-gray-700">
              ...
              <button className="flex items-center px-4 py-2 mt-8 ml-16 border border-primary text-primary hover:bg-gray-100 hover:border-gray-700 rounded-lg transition duration-300">
                Learn More
                <svg
          ...
          <Card className="w-96 bg-gray-50 border border-gray-200 shadow-md rounded-xl p-6 custom-hover-border">
            <CardHeader className="text-gray-900 font-semibold">
              <CardTitle className="text-complementary">Latest Blog Posts</CardTitle>
              <CardDescription>
          ...
          <Card className="w-96 bg-gray-50 border border-gray-200 shadow-md rounded-xl p-6 custom-hover-border">
            <CardHeader className="text-gray-900 font-semibold">
              <CardTitle className="text-complementary">Documentation</CardTitle>
